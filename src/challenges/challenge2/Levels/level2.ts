...
const LEVEL2_PLAYER_MOVEMENT = {
    acceleration: 60,
    maxSpeed: 95,
    inertiaCoefficient: 0.85
};
...
export default class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.player = new PlayerController(this, {
            ...
            inertiaCoefficient: LEVEL2_PLAYER_MOVEMENT.inertiaCoefficient,
            acceleration: LEVEL2_PLAYER_MOVEMENT.acceleration * this.cellSize,
            maxSpeed: LEVEL2_PLAYER_MOVEMENT.maxSpeed * this.cellSize
        }, {
            maze: this.maze,
        ...
        this.add.text(this.scale.width / 2, 24, 'Level 2', {
            fontSize: '26px',
    ...
    private showFailMenu(): void {
        ...
        setCheckpoint("challenge2LoseR2");
    }
